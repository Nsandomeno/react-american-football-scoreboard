  ...
  <div className="away__score">{awayScore}</div>
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick = {() => setQuarter(quarter + 1)} className="HomeButtons__fieldGoal">Quarter</button>
        </div>
        <div className="awayButtons">
          ...
          <button onClick = {() => setDown(down + 1)} className="awayButtons__fieldGoal">Down</button>
        </div>
      </section>
    </div>
  );
